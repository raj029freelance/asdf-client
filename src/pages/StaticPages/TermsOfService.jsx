    ...
    <div className="wrapper">
      <Card title="Terms and Conditions">
        ...
        <p>
          ...
          use of {companyName}'s Website, located at {websiteURL}.
        </p>

        <p>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use {websiteName} if you do not agree
        ...
        <p>
          We employ the use of cookies. By accessing {websiteName}, you agreed
        ...
        <p>
          ...
          {companyName} does not filter, edit, publish or review Comments prior
          to their presence on the website. Comments do not reflect the views
          and opinions of {companyName},its agents and/or affiliates. Comments
          reflect the views and opinions of the person who post their views and
          opinions. To the extent permitted by applicable laws, {companyName}{" "}
        ...
        <p>
          {companyName} reserves the right to monitor all Comments and to remove
        ...
        <p>
          You hereby grant {companyName} a non-exclusive license to use,
        ...
        <p>
          ...
          the hyperlink compensates the absence of {companyName}; and (d) the
        ...
        <p>
          ...
          sending an e-mail to {companyName}. Please include your name, your
        ...
        <p>
          No use of {companyName}'s logo or other artwork will be allowed for
